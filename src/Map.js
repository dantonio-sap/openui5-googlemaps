sap.ui.define(
  ...
  function (jQuery, Control, ResizeHandler, Gmaps, MapUtils, MapTypeId) {
      ...
      if (Gmaps.loaded === undefined) {
        if (this.subscribed === undefined) {
          sap.ui
            .getCore()
            .getEventBus()
            .subscribe(Gmaps.notifyEvent, this.createMap, this);
    ...
    Map.prototype.fitToSelectedMarkers = function (aMarkers) {
      if (this.map && aMarkers.length > 0) {
